...
- $y=sum(x)$时，导数为：$a\frac{\partial{u}}{\partial{\mathbf{x}}}$
- $y=\vert\vert \mathbf{x} \vert\vert^2$时，导数为：$x$
| y   | a   | au  | sum(x) | $\vert\vert \mathbf{x} \vert\vert^2$ |
| --- | --- | --- | ------ | ----------------------------------- |
|  $\partial{y}/\partial{\mathbf{x}}$   |  $\mathbf{0}^T$   |  $a\frac{\partial{u}}{\partial{\mathbf{x}}}$   |   $\mathbf{1}^T$     |                                     |
## 向量对标量的导数
