...
> 造成这个的原因是本公式使用的是**分子布局**，其实一般会使用分母布局，他们互为转置。但这里与[课程矩阵计算](https://www.bilibili.com/video/BV1eZ4y1w7PY?p=2&vd_source=8fc1ba7db0ecc643e9aacb066fe696cb)和[维基百科]()保持
> 若使用**分母布局**，则结果为列向量。
